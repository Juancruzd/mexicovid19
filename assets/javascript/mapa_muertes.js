...
var navMap = d3.select("#mapa_muertes").append("div")
    .attr("class", "nav_map")
    .style("opacity", 0);
...
//svg
var mapSvg = d3.select("#mapa_muertes")
    .append("svg")
    .attr("width", w)
    .attr("height", h);
...
d3.json(url, function(json) {
    ...
    // Colores
    var palette= d3.schemePurples[9];
    ...
    .domain(d3.extent(json.features, function(d){return d.properties.muertes_100k}))
    .range(palette);
    ...
    mapSvg.selectAll("path")
        ...
        .append("path")
        .attr("d", path)
        .attr('fill', function(d) {return color(d.properties.muertes_100k)})
